...
public class Day3ex2 {
    ...
    public static void main(String[] args) {
            ...
            System.out.println(repeatFinder("Ну что ж я, я найти решения правильного не смогу ж? Смогу ж конечно, я ж старательный все ж таки.",3));
    ...
    public static String repeatFinder(String sourseText,int maxFrequency){
        ...
        String formattedText =sourseText.toLowerCase().replaceAll("[\\.,?!:]","");
